...
![Standard Money](../assets/revenue.png)
...
Fees are designed to be competitive while ensuring protocol sustainability and covering operational costs. The fee structure can be adjusted to optimize for different market conditions and ensure long-term protocol viability.
...
Revenue allocation can be adjusted to optimize for different market conditions. The community can participate in decisions that affect revenue generation and distribution, ensuring the protocol remains responsive to changing market dynamics.
...
<Columns cols={2}>
  <Card
    ...
    icon="chart-line"
    href="https://app-test.standardmoney.com"
  >
