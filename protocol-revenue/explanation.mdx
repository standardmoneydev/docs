...
Standard Money uses advanced algorithms to short perps and long spot simultaneously, earning yields from exchanges like Binance, OKX, and Bybit in real-time. The protocol is currently earning 8% APY with potential for up to 30% annual returns generated through perpetual futures trading. These basis trade yields are automatically distributed to sUSDsd holders as part of their rewards, providing the primary yield component.

The yield rate varies based on market conditions, with higher volatility generally leading to higher funding rates and increased revenue. The protocol continuously optimizes its trading strategies to maximize yield while maintaining effective risk management.
...
>
  ...
  <Card title="Governance" icon="users" href="/solution-design/governance">
